defmodule Bout.Contests.Janitor do
  @moduledoc """
  ...
  def init(opts) do
    interval =
      Keyword.get(opts, :interval_ms, Application.get_env(:bout, :janitor_interval_ms, :timer.hours(1)))
  ...
  def handle_info(:sweep, state) do
    case Bout.Contests.expire_stale(@cutoff_hours) do
