defmodule Bout.Drafts.Server do
  @moduledoc """
  ...
  Registered by `draft_id` in `Bout.Drafts.Registry`; broadcasts every state
  ...
  alias Bout.Drafts
  alias Bout.Drafts.{AutoPick, Lineup, PoolFilter}
  ...
  def via_tuple(draft_id), do: {:via, Registry, {Bout.Drafts.Registry, draft_id}}
  ...
  def init(opts) do
    ...
    players = Bout.Contests.draft_players(duel)
