defmodule Bout.DevTools do
  ...
  and calls `Settlement.settle_duel/1`.
      ...
      iex> Bout.DevTools.settle_on_date(42, ~D[2026-06-28])
  ...
  defp dev?, do: Application.get_env(:bout, :dev_routes, false) == true
end
