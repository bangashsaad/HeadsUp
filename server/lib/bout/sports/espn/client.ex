defmodule Bout.Sports.Espn.Client do
  @moduledoc """
  ...
  defp host(key, default) do
    Application.get_env(:bout, Bout.Sports.Espn, []) |> Keyword.get(key, default)
  end

  defp request(url, params) do
    opts = Application.get_env(:bout, Bout.Sports.Espn, []) |> Keyword.get(:req_options, [])
