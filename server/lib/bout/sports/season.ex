defmodule Bout.Sports.Season do
  @moduledoc """
  ...
  def window_days, do: Application.get_env(:bout, :playable_window_days, 10)
  ...
  defp default_client, do: Application.get_env(:bout, :season_client, Client)
end
