defmodule Bout.Settlement.Stats.MlbEspn do
  @moduledoc """
  ...
  `config :bout, #{inspect(__MODULE__)}, client: Mod` for offline tests.
  """
  @behaviour Bout.Settlement.StatsProvider

  require Logger

  alias Bout.Contests.Scoring
  alias Bout.Settlement.Window
  alias Bout.Settlement.Stats.WindowScan
  alias Bout.Sports.Espn.Client
  alias Bout.Sports.Gamelog
  ...
  defp client do
    Application.get_env(:bout, __MODULE__, [])
