defmodule Bout.Notifications do
  @moduledoc """
  ...
  Config:
      ...
      config :bout, Bout.Notifications,
        enabled: true,
  ...
  defp in_background(fun) do
    Task.Supervisor.start_child(Bout.Notifications.TaskSupervisor, fun)
  end

  defp enabled?, do: config(:enabled, false)

  defp config(key, default) do
    Application.get_env(:bout, __MODULE__, []) |> Keyword.get(key, default)
  end
end
