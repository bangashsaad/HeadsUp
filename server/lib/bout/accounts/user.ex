defmodule Bout.Accounts.User do
  use Ecto.Schema
  ...
  schema "users" do
    ...
    has_many :tokens, Bout.Accounts.UserToken
  ...
  defp validate_username(changeset) do
    ...
    |> unsafe_validate_unique(:username, Bout.Repo)
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Bout.Repo)
  ...
  """
  def valid_password?(%Bout.Accounts.User{hashed_password: hashed_password}, password)
