defmodule Bout.Accounts.UserToken do
  use Ecto.Schema
  import Ecto.Query
  ...
  schema "users_tokens" do
    ...
    belongs_to :user, Bout.Accounts.User
  ...
  def by_token_and_context_query(token, context) do
    from Bout.Accounts.UserToken, where: [token: ^token, context: ^context]
  end

  @doc "All tokens belonging to a user."
  def by_user_and_contexts_query(user, :all) do
    from t in Bout.Accounts.UserToken, where: t.user_id == ^user.id
  end
end
