defmodule BoutWeb.GameController do
  use BoutWeb, :controller

  alias Bout.Sports.{BoxScore, Schedule}
  alias Bout.Sports.Espn.Client

  plug :put_view, json: BoutWeb.GameJSON
  ...
  def season(conn, _params) do
    json(conn, %{sports: Bout.Sports.Season.statuses()})
  end
  ...
  def slates(conn, %{"sport" => sport}) do
    slates =
      case Bout.Sports.Slate.upcoming(sport) do
