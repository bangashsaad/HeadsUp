defmodule BoutWeb.UserSocket do
  @moduledoc """
  ...
  channel "draft:*", BoutWeb.DraftChannel

  @impl true
  def connect(%{"token" => token}, socket, _connect_info) do
    case Bout.Accounts.get_user_by_api_token(token) do
      %Bout.Accounts.User{} = user -> {:ok, assign(socket, :current_user_id, user.id)}
      _ -> :error
    end
  end
