defmodule BoutWeb.DraftChannel do
  @moduledoc """
  ...
  process is alive, then forwards client intents to `Bout.Drafts.Server` and
  ...
  alias Bout.{Contests, Drafts}
  alias Bout.Drafts.{Server, Supervisor}
  ...
  # Engine PubSub broadcast (same topic on Bout.PubSub) -> push to this client.
