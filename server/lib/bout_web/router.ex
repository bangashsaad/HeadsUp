defmodule BoutWeb.Router do
  use BoutWeb, :router

  import BoutWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {BoutWeb.Layouts, :root}
  ...
  if Application.compile_env(:bout, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: BoutWeb.Telemetry
