defmodule Bout.Sports.Espn.ClientTest do
  # async: false — each test installs its own Req.Test stub and swaps app env.
  use ExUnit.Case, async: false

  alias Bout.Sports.Espn.Client

  @stub Bout.Sports.Espn.ClientTest.Stub

  setup do
    prev = Application.get_env(:bout, Bout.Sports.Espn)

    Application.put_env(:bout, Bout.Sports.Espn,
    ...
    on_exit(fn -> Application.put_env(:bout, Bout.Sports.Espn, prev) end)
    :ok
  end
