defmodule Bout.Sports.SeasonTest do
  ...
  alias Bout.Sports.{Player, Season}
  ...
  test "challenge creation is blocked when ESPN positively says: no games" do
    ...
    Application.put_env(:bout, :season_client, EmptyStub)

    on_exit(fn ->
      Application.delete_env(:bout, :season_client)
      :persistent_term.erase({Bout.Sports.Season, "nba"})
    end)
