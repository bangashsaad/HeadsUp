defmodule Bout.CoinsDuelsTest.StubStats do
  @moduledoc false
...
defmodule Bout.CoinsDuelsTest do
  @moduledoc """
  ...
  alias Bout.{Accounts, Coins, Contests, Drafts, Repo, Settlement}
  alias Bout.Coins.Integrity
  ...
  setup do
    Application.put_env(:bout, :stats_provider, Bout.CoinsDuelsTest.StubStats)
