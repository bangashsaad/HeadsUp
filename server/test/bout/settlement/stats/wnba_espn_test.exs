defmodule Bout.Settlement.Stats.WnbaEspnTest do
  use ExUnit.Case, async: false

  alias Bout.Settlement.Stats.WnbaEspn
  ...
  setup do
    prev = Application.get_env(:bout, WnbaEspn)
    Application.put_env(:bout, WnbaEspn, client: StubClient)
    on_exit(fn -> Application.put_env(:bout, WnbaEspn, prev) end)
    :ok
  end
