defmodule Bout.Settlement.Stats.MlbEspnTest do
  use ExUnit.Case, async: false

  alias Bout.Settlement.Stats.MlbEspn
  ...
  setup do
    prev = Application.get_env(:bout, MlbEspn)
    Application.put_env(:bout, MlbEspn, client: StubClient)
    on_exit(fn -> Application.put_env(:bout, MlbEspn, prev) end)
    :ok
  end
