...
One duel's full picture: parties, status, complete terms, scoring chart, and the actions that status allows (accept / decline / counter / cancel / enter draft / open live / results / rematch).
